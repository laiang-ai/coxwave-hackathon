...
> = {
	...
	"sticker-pack": {
		label: "Sticker Pack",
		prompt: "Die-cut sticker sheet with brand marks, flat lay composition.",
	...
	"merchandise-flatlay": {
		label: "Merch Flatlay",
		prompt: "Merch lineup from top-down view, tidy arrangement, soft shadows.",
	...
	"app-onboarding": {
		...
		prompt: "Mobile onboarding screens on a smartphone, soft light, clean UI.",
		defaultHint: "Example: onboarding carousel",
	},
	"app-splash": {
		label: "App Splash",
		prompt: "App splash screen on a device, minimal UI, strong logo focus.",
	...
	"pitch-deck-cover": {
		...
		prompt: "Pitch deck cover on a tablet or laptop, strong title and logo.",
		defaultHint: "Example: investor deck",
	},
	"instagram-feed": {
		label: "Instagram Feed",
		prompt: "Instagram feed grid on a smartphone, cohesive post visuals.",
		defaultHint: "Example: social feed series",
	},
	"instagram-story": {
		label: "Instagram Story",
		prompt: "Instagram story layout on a smartphone, bold typography and CTA.",
		defaultHint: "Example: story announcement",
	},
	"tiktok-thumbnail": {
		label: "TikTok Thumbnail",
		prompt: "Short-form video thumbnail on a phone, bold framing and title.",
		defaultHint: "Example: launch teaser",
	},
	"youtube-thumbnail": {
		label: "YouTube Thumbnail",
		prompt: "YouTube video thumbnail with bold framing and high-contrast text.",
