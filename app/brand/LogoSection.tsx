...
const LogoTile = ({
	...
	return (
		<figure
			className="flex h-full flex-col items-center justify-center gap-3 border p-4 text-center shadow-[0_25px_60px_rgba(15,23,42,0.08)]"
			style={frameStyle}
		>
			...
			{hasError ? (
				<div
					className="flex h-36 w-56 items-center justify-center border border-dashed text-xs"
					style={{
						borderColor: theme.light.border.default,
